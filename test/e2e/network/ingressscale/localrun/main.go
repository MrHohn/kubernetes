...
func registerFlags() {
	...
	flag.Var(&numIngressesTest, "ingresses-num", "The number of ingresses to test, specify multiple times for step testing (e.g. 5 ingresses -> 20 ingresses -> 100 ingresses)")
